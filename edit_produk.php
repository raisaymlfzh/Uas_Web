...
$result = mysqli_query($conn, "SELECT * FROM raisa_produk WHERE Id_product = $id");
if (!$result) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE raisa_produk SET product_name=?, description=?, price=?, stok=?, image_product=? WHERE Id_product=?");
